            ...
            <div className="px-6 py-6 space-y-6">
                ...
                <div className="flex flex-col items-center text-center">
                    <div className="relative mb-6">
                        {/* Status Label Popup */}
                        <div className={`absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] border-2 shadow-lg z-20 backdrop-blur-md ${String(studentData?.hostel_type).toLowerCase().includes('dayscholar')
                        ...
                        <div className={`w-44 h-44 rounded-full overflow-hidden border-4 bg-white relative z-10 shadow-2xl transition-all duration-500 ${isDenied
                        ...
                        <div className={`absolute bottom-2 right-2 w-10 h-10 rounded-full flex items-center justify-center border-4 border-white shadow-lg z-20 ${isDenied ? 'bg-rose-500' : 'bg-[#a6cc39]'
                            }`}>
                ...
                <div className={`${isDenied
                    ...
                    <div>
                        <h3 className={`${isDenied ? 'text-rose-600' : warning ? 'text-amber-600' : 'text-[#a6cc39]'
                    ...
                    <div className={`flex items-center gap-2 ${isDenied
