                ...
                {loading ? (
                    ...
                    notifications.map((n) => (
                        <div
                            ...
                            className={`group relative bg-white rounded-[28px] p-5 border shadow-sm transition-all duration-300 hover:shadow-md active:scale-98 cursor-pointer ${!n.is_read ? 'border-orange-100 bg-orange-50/5' : 'border-gray-50'
                                }`}
                        >
                            {!n.is_read && (
